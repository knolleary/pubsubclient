...
public:
   ...
   PubSubClient(const char*, uint16_t, void(*)(char*,uint8_t*,unsigned int),Client& client);
   PubSubClient(const char*, uint16_t, void(*)(char*,uint8_t*,unsigned int),Client& client, Stream&);
